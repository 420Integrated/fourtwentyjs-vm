...
export const SKIP_BROKEN = [
  ...
  'sha3_bigOffset', // SHA3: Only BlockchainTest, unclear SHA3 test situation (2020-05-28) (https://github.com/420integrated/fourtwentyjs-vm/pull/743#issuecomment-635116418)
  'sha3_memSizeNoQuadraticCost', // SHA3: See also:
  'sha3_memSizeQuadraticCost', // SHA3: https://github.com/420integrated/fourtwentyjs-vm/pull/743#issuecomment-635116418
  'sha3_bigSize', // SHA3
...
/**
 * VMTests have been deprecated, see https://github.com/420integrated/go-420coin/tests/issues/593
 * skipVM test list is currently not used but might be useful in the future since VMTests
 * have now been converted to BlockchainTests, see https://github.com/420integrated/go-420coin/tests/pull/680
...
export function getTestDirs(network: string, testType: string) {
  ...
  for (const key in testLegacy) {
    if (key.toLowerCase() == network.toLowerCase() && testLegacy[key]) {
      ...
      // https://github.com/420integrated/go-420coin/tests/releases/tag/v7.0.0-beta.1
