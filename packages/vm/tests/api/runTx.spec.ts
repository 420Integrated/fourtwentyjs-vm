...
import { Address, BN, MAX_INTEGER } from 'fourtwentyjs-util'
...
tape('should run simple tx without errors', async (t) => {
  ...
  t.true(res.smokeUsed.gt(new BN(0)), 'should have used some smoke')
...
// Please refer to https://github.com/420integrated/fourtwentyjs-vm/issues/353
