...
import { Account, Address, BN, privateToAddress, bufferToHex } from 'fourtwentyjs-util'
import { Transaction } from '@fourtwentyjs/tx'
import VM from '../../dist'

const abi = require('fourtwentyjs-abi')
...
async function deployContract(
  ...
  const txData = {
    value: 0,
    smokeLimit: 2000000, // We assume that 2M is enough,
    smokePrice: 1,
