...
import { genesisStateByName } from '@fourtwentyjs/common/dist/genesisStates'
...
export interface DefaultStateManagerOpts {
  /**
   * Parameters of the chain ([`Common`](https://github.com/420integrated/fourtwentyjs-common))
   */
  common?: Common
  /**
   * A [`merkle-patricia-tree`](https://github.com/fourtwentyjs/merkle-patricia-tree) instance
   */
  trie?: Trie
}
...
export default class DefaultStateManager implements StateManager {
  ...
  async revert(): Promise<void> {
    ...
    // Exceptional case due to consensus issue in G420 and Parity.
