...
export default class Interpreter {
   ...
   * reducing it's base smoke cost, and increments the program counter.
   */
  async runStep(): Promise<void> {
    ...
    this._eei.useSmoke(new BN(opInfo.fee))
  ...
  async _runStepHook(): Promise<void> {
    ...
    const eventObj: InterpreterStep = {
      ...
      smokeLeft: this._eei.getSmokeLeft(),
      opcode: {
     ...
     * @property {BN} smokeLeft amount of smokeLeft
