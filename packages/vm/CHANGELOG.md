...
See [v4.0.0-beta.1](https://github.com/420integrated/fourtwentyjs-vm/releases/tag/v4.0.0-beta.1)
...
- Usage of the latest `rustbn.js` API, see PR [#312](https://github.com/420integrated/fourtwentyjs-vm/pull/312)
