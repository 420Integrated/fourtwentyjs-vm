...
import { BN, rlp, keccak256, KECCAK256_RLP } from 'fourtwentyjs-util'
...
export class Block {
   ...
   * @param parentBlock - the parent of this `Block`
   */
  validateSmokeLimit(parentBlock: Block): boolean {
    return this.header.validateSmokeLimit(parentBlock.header)
  }
  ...
  private _validateUncleHeader(uncleHeader: BlockHeader, blockchain?: Blockchain) {
    ...
    // This is not possible in fourtwentyjs-blockchain since this PR was merged:
    // https://github.com/420integrated/fourtwentyjs-blockchain/pull/47
