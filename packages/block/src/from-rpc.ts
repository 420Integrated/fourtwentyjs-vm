import { Transaction, TxData } from '@fourtwentyjs/tx'
import { toBuffer, setLengthLeft } from 'fourtwentyjs-util'
 ...
 * @param uncles - Optional list of 420coin JSON RPC of uncles (fourtwenty_getUncleByBlockHashAndIndex)
